/**
 * @file Tester.java
 * @brief JUnit 4 test suite for Prowl simulation.
 *        Tests 1-5 verify OOP structure via source file scanning.
 *        Tests 6-10 validate simulation output against expected values.
 */
package prowl;
...
public class Tester {
    ...
    // source root for file-based OOP checks
    private static final String SRC_ROOT = "./src/main/java/prowl/";

    // checks if a source file contains a given phrase (ignoring whitespace)
    private boolean checkInFile(String filename, String phrase) {
        try {
            File    file    = new File(SRC_ROOT + filename);
    ...
    public void test6() {
        ...
        assertEquals(expected, getCommandLineOutput("java -cp work prowl.Simulator 1 0 0 10 40"));
    }
    ...
    public void test7() {
        ...
        assertEquals(expected, getCommandLineOutput("java -cp work prowl.Simulator 1 0 0 21 30"));
    }
    ...
    public void test8() {
        ...
        assertEquals(expected, getCommandLineOutput("java -cp work prowl.Simulator 1 0 0 23 30"));
    }
    ...
    public void test9() {
        ...
        assertEquals(expected, getCommandLineOutput("java -cp work prowl.Simulator 1 5 0 30 35"));
    }
